class SnakeGame:
    ...
    def move(self, direction: str) -> int:
        ...
        crosses_bound1 = newHead[0] < 0 or newHead[0] >= self.height
        crosses_bound2 = newHead[1] < 0 or newHead[1] >= self.width
        bites_itself = newHead in self.snake_set and newHead != self.snake[-1]

        if crosses_bound1 or crosses_bound2 or bites_itself:
            return -1
